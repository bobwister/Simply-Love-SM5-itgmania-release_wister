...
return LoadFont(ThemePrefs.Get("ThemeFont") .. " Bold")..{
	...
	GainFocusCommand=function(self) self:stoptweening():linear(0.1):zoom(1.0):diffuse(PlayerColor(PLAYER_1)) end,
	LoseFocusCommand=function(self) self:stoptweening():linear(0.1):zoom(0.5):diffuse({1.0, 1.0, 1.0, 1.0}) end,
