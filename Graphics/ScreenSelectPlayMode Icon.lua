...
return LoadFont(ThemePrefs.Get("ThemeFont") .. " Bold")..{
	...
	GainFocusCommand=function(self) self:stoptweening():linear(0.1):zoom(0.75):diffuse(GetHexColor(SL.Global.ActiveColorIndex, true)) end,
	LoseFocusCommand=function(self) self:stoptweening():linear(0.1):zoom(0.3):diffuse({1.0, 1.0, 1.0, 1.0}) end,
