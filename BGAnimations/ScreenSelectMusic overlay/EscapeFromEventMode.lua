...
local af = Def.ActorFrame{
	...
	ShowCommand=function(self)
		...
		if topscreen then
			...
			choice_actors[0]:stoptweening():diffuse(PlayerColor(PLAYER_1)):zoom(1.1)
	...
	ChangeChoiceCommand=function(self)
		...
		choice_actors[active_index]:diffuse(PlayerColor(PLAYER_1)):stoptweening():linear(0.1):zoom(1.1)
		--play sound effect
		sfx.change:play()
	end,
...
local no = Def.ActorFrame{
	InitCommand=function(self)
		...
		self:y(250):diffuse(PlayerColor(PLAYER_1))
	end,
